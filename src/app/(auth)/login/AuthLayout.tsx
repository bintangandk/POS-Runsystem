...
export default function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#effcfb] overflow-hidden">
      ...
      <div
        className="absolute top-50 left-0 right-0 flex justify-center"
        style={{ zIndex: 1 }}
      >
        <img
          src="/bg-vector.svg"
